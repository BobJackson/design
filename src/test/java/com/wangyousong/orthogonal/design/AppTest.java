...
class AppTest {
    ...
    void should_find_student() {
        assertThat(find(students, ageEq(18)), notNullValue());
    ...
    @Test
    void should_find_female_student() {
        assertThat(find(students, ageNe(18).and(s-> s.gender().equals(FEMALE))), notNullValue());
    }
